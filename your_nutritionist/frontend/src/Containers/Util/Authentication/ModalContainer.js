...
class ModalContainer extends Component {
	...
	CodeToModal = (modalCode) => {
		switch (this.props.modalType) {
			...
			case 3:
				return <ForgotPasswordForm hideModal={this.props.hideModal}></ForgotPasswordForm>;
			case 4:
				return (
					<SigninRequiredForm
						showSigninModal={this.showSigninModal}
	...
	submitInfoHandler = (event) => {
		event.preventDefault();
		this.props.submitHeadline(
			this.state.user_info.headline,
			this.props.userId,
			this.props.token
		);
