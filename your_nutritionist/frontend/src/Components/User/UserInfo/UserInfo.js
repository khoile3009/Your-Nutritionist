                    ...
                    <div className="username">
                        ...
                        <span className='subtitle'>@{props.user_info.username}</span>
                        {
                            ...
                            ? <>
                                <div xs="auto" md="auto" lg="auto" className="edit-headline-wrapper" >
                                    <Form onSubmit={props.submitHeadline}>
                                        ...
                                        <br></br>
                                        <Button className='edit-intro-cancel-btn' onClick={props.stopHeadlineEdit}>Cancel</Button>
                                        <Button className='edit-intro-btn' type='submit'>Edit</Button>
                            ...
                            <div className="headline-wrapper">
                                <div className='headline'><span style={{fontSize: "24pt", fontWeight: "bold"}}>&ldquo;</span>{props.user_info.headline}{props.logged_in && props.isSelf ? (<Button onClick={props.startHeadlineEdit} className="edit-intro-btn">&nbsp;<i class="material-icons">edit</i></Button>) : null}</div>
                            </div>
                            </>
                        }
