        ...
        <Form onSubmit={props.registerHandler}>
            <Modal.Body>
                <Form.Group controlId="formGroupUsername">
                    ...
                    {props.ok.okUsername === false ? <Form.Text className='error'>Username should be at least 6 characters</Form.Text> : null}
                </Form.Group>
                <Form.Group>
                    <Form.Label>Name</Form.Label>
                    <Row>
                        <Col>
                            <Form.Control placeholder="First name" name='first_name' onChange={props.first_nameChangeHandler} value={props.auth.first_name}/>
                        </Col>
                        <Col>
                            <Form.Control placeholder="Last name" name='last_name' onChange={props.last_nameChangeHandler} value={props.auth.last_name}/>
                        </Col>
                    </Row>
...
const SigninRequiredForm = (props) => {
    return <>
        ...
        <Modal.Body>
            <p>
                Only a registered user can use this feature
            </p>
        ...
        <Form onSubmit={props.submitInfoHandler}>
            <Modal.Body>
                <Form.Group controlId="formGroupHeadline">
                    ...
                    <Form.Control type="text" name="headline" placeholder="Current jobs, favorite quotes, etc" onChange={props.headlineChangeHandler} value={props.user_info.headline} />
                </Form.Group>
                <Form.Group controlId="formGroupIntroduction">
                    <Form.Label>Introduction</Form.Label>
                    <Form.Control as="textarea" placeholder="Hi I'm.. " name="introduction" value={props.user_info.information} onChange={props.introductionChangeHandler} rows="3" />
                </Form.Group>
            </Modal.Body>
            <Modal.Footer>
                <Button variant="secondary" onClick={props.hideModal}>
