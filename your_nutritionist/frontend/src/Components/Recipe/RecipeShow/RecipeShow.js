	...
	return (
		<>
			...
			<Row>
				<Col>
					<p className="subtitle text-left">
						{props.recipe.number_person} servings | Prep Time: {props.recipe.prep_time}{" "}
						minutes | Cook Time: {props.recipe.cook_time} minutes
					</p>
				</Col>
			</Row>
			...
			<Row>
				<Col xs>
					<IngredientSections
						ingredient_sections={props.recipe.ingredient_sections}
					></IngredientSections>
				</Col>
				<Col xs={8}>
					<StepsSections
